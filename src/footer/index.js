                ...
                <Grid container justify="center" alignItems="flex-start" spacing={2} xs={12} md={11} lg={10}>
                    <Grid item sm={4} xs={11}>
                        <ContentBox>
                            ...
                            <p>I had the idea for this website while reading about the <a href="https://towardsdatascience.com/step-by-step-guide-on-how-to-train-gpt-2-on-books-using-google-colab-b3c6fa15fef0">fun</a> people were having fine-tuning <a href="https://openai.com/blog/better-language-models/" target="_blank" rel="noopener noreferrer">OpenAI's GPT-2 text model</a>.
